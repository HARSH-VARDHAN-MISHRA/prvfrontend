...
const AdminOrder = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://www.api.prvlite.com/api/order");
    ...
    const confirmOrder = async () => {
        try {
            let res = await axios.post("https://www.api.prvlite.com/api/order/confirm", consOrder)
            console.log(res);
    ...
    const cancelOrder = async () => {
        try {
            const res = await axios.post("https://www.api.prvlite.com/api/order/cancel", { consOrder });
            toast.success(res.data.message);
            getApiData();
        } catch (error) {
            toast.error(error.response.data.message || error.response.data.msg);
